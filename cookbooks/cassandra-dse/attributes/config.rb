default['cassandra']['config']['cluster_name'] = 'wolfercassandra'
...
default['cassandra']['config']['concurrent_reads'] = 16 # suggested at 16 * number of drives
default['cassandra']['config']['concurrent_writes'] = 8 # suggested at 8 * number of cpu cores
...
default['cassandra']['config']['rpc_server_type'] = 'hsha' # 'sync' or 'hsha'
default['cassandra']['config']['rpc_min_threads'] = 4
default['cassandra']['config']['rpc_max_threads'] = 16
...
default['cassandra']['config']['compaction_throughput_mb_per_sec'] = 0
...
if node['cassandra']['version'] >= '2.1'
  ...
  default['cassandra']['config']['concurrent_counter_writes'] = 4
